...
for file in $(pwd)/dotfiles/.{tmux.conf,aliases,functions,zfunctions,zshenv,zshrc,ctags,gitconfig,bin,curlrc,wgetrc,i3,npmrc,yarnrc,pacconfig,vimrc,vim,xsession,Xresources}
do
	    ln -sf "$file" ~
done
unset file;
